...
protected:
    BOOL OpenNextSegment()
    {
        ...
        if (m_pvBuffer == NULL)
        {
            ...
            m_pvBuffer = m_malloc(m_MaxBufferSize);
            if (m_pvBuffer == NULL)
                return FALSE;
        }
        ...
        if (m_pvComressedBuffer == NULL)
        {
            ...
            m_pvComressedBuffer = m_malloc(m_CompressedBufferSize);
            if (m_pvComressedBuffer == NULL)
                return FALSE;
        }
        ...
        LOOP_ONCE
        {
            ...
            pbCompressed = (PBYTE)m_malloc(m_pCurSegm->ArchiveSize.LowPart);
